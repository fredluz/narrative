                  ...
                  <ScrollView style={{ flex: 1 }} bounces={false}>
                    <Card style={[{ 
                      ...
                      <View style={{ padding: 20 }}>
                        ...
                        {/* Display quest memos */}
                        {selectedQuest.memos && selectedQuest.memos.length > 0 && (
                          <View style={{
                            backgroundColor: 'rgba(20, 20, 20, 0.7)',
                            borderRadius: 6,
                            padding: 15,
                            ...
                            <View style={{ 
                              ...
                              <MaterialIcons name="history-edu" size={18} color={brightAccent} style={{ marginRight: 8 }} />
                              <Text style={{ 
                                fontSize: 16,
                                color: '#FFF',
                                fontWeight: '600'
                            ...
                            {selectedQuest.memos
                              ...
                              .map((memo, index) => {
                                ...
                                const formattedTime = memoDate.toLocaleTimeString('en-US', {
                                  hour: '2-digit',
                                  minute: '2-digit',
                                  hour12: false
                                });
                                ...
                                return (
                                  <View key={memo.id} style={{
                                    ...
                                    marginBottom: 8,
                                    borderLeftWidth: 2,
                                    borderLeftColor: memo.source === 'chat' ? themeColor : secondaryColor
                                  }}>
                                    <Text style={{ 
                                      fontSize: 14,
                                      color: '#DDD',
                                    ...
                                    <View style={{ 
                                      ...
                                      <MaterialIcons 
                                        name={memo.source === 'chat' ? 'chat' : 'edit-note'} 
                                        size={14} 
                                        color="#999"
                                        style={{ marginRight: 4 }}
                                      />
